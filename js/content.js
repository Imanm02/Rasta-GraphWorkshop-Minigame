...
var contentData = // jshint ignore:line
{
  "vertices-and-edges": {
    ...
    "theory-content": "<div><span style: 'whitespace: nowrap'>Aaaaaaaaaa graph is a collection of vertices<\/span><span style: 'whitespace: nowrap'><svg width=30 height=30 xml:space='preserve' style='margin-left: 4; margin-right: 0 position:relative'><g><circle cx='15' cy='15' r='10' fill='#1f77b4'/></g></svg><\/span><span style: 'whitespace: nowrap'><svg width=30 height=30 xml:space='preserve' style='margin-left: 0; margin-right: 0; position:relative'><g><circle cx='15' cy='15' r='10' fill='#ff7f0e'/></g></svg><\/span><span style: 'whitespace: nowrap'><svg width=30 height=30 xml:space='preserve' style='margin-left: 0; margin-right: 4; position:relative'><g><circle cx='15' cy='15' r='10' fill='#2ca02c'/></g></svg><\/span><span style: 'whitespace: nowrap'>interconnected by edges<\/span><span style: 'whitespace: nowrap'><svg width=30 height=30 xml:space='preserve' style='margin-left: 4; margin-right: 0 position:relative'><g><line x1='5' y1='25' x2='25' y2='5' stroke='#888' stroke-width='2px' stroke-linecap='round' stroke-linejoin='round'/></g></svg><\/span><span style: 'whitespace: nowrap'><svg width=30 height=30 xml:space='preserve' style='margin-left: 0; margin-right: 0; position:relative'><g><line x1='5' y1='25' x2='25' y2='5' stroke='#888' stroke-width='2px' stroke-linecap='round' stroke-linejoin='round'/></g></svg><\/span><span style: 'whitespace: nowrap'><svg width=30 height=30 xml:space='preserve' style='margin-left: 0; margin-right: 0; position:relative'><g><line x1='5' y1='25' x2='25' y2='5' stroke='#888' stroke-width='2px' stroke-linecap='round' stroke-linejoin='round'/></g></svg><\/span><span style: 'whitespace: nowrap'>.  We denote the set of all vertices by \\(V\\) and set of all edges by \\(E\\).<\/p><p>Got it? Now in easy words: A graph has two components - a <b>set of vertices<\/b> \\(V\\) AND a <b>set of edges<\/b> \\(E\\). Where an edge is something acting as a link between two vertices. Period.<\/p><p>If an edge connects two vertices \\(v_1\\) and \\(v_2\\), then we denote the edge by \\(v_1v_2\\), which is same as \\(v_2v_1\\).<\/p><p>Two vertices are said to be <b>adjacent<\/b> if they are connected by an edge.<\/p><p>Now read the instructions below and create your own graph. You will see the corresponding sets \\(V\\) and \\(E\\) below the graph area. Start playing around and get yourself comfortable with the set notations.<\/span><\/div>",

    "interface-title": "روش استفاده از برنامه:",

    "interface-content": "<ul> <li>برای اضافه کردن یک راس روی فضای سفید کلیک چپ کنید.<\/li><li>برای اضافه کردن یک یال، از یک راس به دیگری بکشید.<\/li><li>برای حذف یک راس یا یال، روی آن راست کلیک کنید.<\/li><li>برای حرکت دادن یک راس، کنترل را نگه دارید و آن را حرکت دهید.<\/li><li>برای مشاهده‌ی نام یک راس یا یال، کافی‌ست نشان‌گر خودتان را روی آن نگه دارید.<\/li><\/ul>",

    "svg-buttons": "<button type=\"button\" id=\"clear-graph\" class=\"btn btn-default\">پاک کردن همه</button>",
  ...
  "walk": {
    ...
    "svg-buttons": "<button type=\"button\" id=\"clear-graph\" class=\"btn btn-default\">پاک کردن همه<\/button> <button type=\"button\" id=\"clear-walk\" class=\"btn btn-default\">Clear Walk<\/button> <button type=\"button\" id=\"reverse-walk\" class=\"btn btn-default\">Reverse Walk<\/button>",
