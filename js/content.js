...
var contentData = // jshint ignore:line
{
  "vertices-and-edges": {
    ...
    "interface-content": "<ul> <li>برای اضافه کردن یک راس روی فضای سفید کلیک چپ کنید.<\/li><li>برای اضافه کردن یک یال، از یک راس به دیگری بکشید.<\/li><li>برای حذف یک راس یا یال، روی آن راست کلیک کنید.<\/li><li>برای حرکت دادن یک راس، Ctrl را نگه دارید و آن را حرکت دهید.<\/li><li>برای مشاهده‌ی نام یک راس یا یال، کافی‌ست نشان‌گر خودتان را روی آن نگه دارید.<\/li><\/ul>",
